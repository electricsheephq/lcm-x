...
LCM_RECALL = {
    ...
    "description": (
        ...
        "lcm_expand(node_id=...), and cross-session summary hits get lcm_expand(node_id=..., session_id=...). "
        ...
        "properties": {
            ...
            "session_id": {
                ...
                "description": (
                    ...
                    "Omit to preserve current-session scope; an explicit id must be non-empty and match the node."
                ),
            },
            "externalized_ref": {
                "type": "string",
