...
# The tests that stay live ask TeamsPolicy what predicate it PRODUCES, which is
# this slice's subject.  The ones below inspect store/vector_store/tools source
# for the code that CONSUMES it, and that arrives with the call sites.
_NEEDS_CONSUMERS = pytest.mark.skip(
    reason="call-site slice: store/vector_store/tools do not consume the predicate yet"
)
