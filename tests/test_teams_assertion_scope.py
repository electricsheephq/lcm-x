...
# The owner predicate these tests pin is a parameter on AssertionStore's query
# paths, which is a call-site change; slice 2 lands the policy that WOULD supply
# it (TeamsPolicy.resolve_authorized_targets) and no store signatures.
_NEEDS_STORE_PREDICATE = pytest.mark.skip(
    reason="call-site slice: AssertionStore has no access_scope parameter yet"
)
