...
> validator were removed. It produced 0 v2 passes; the 3 merges after v2 (#462, #466, #470)
> landed through ruleset transitions; and no publisher ever emitted the `lcm-x-ai-review:v2`
> marker. AI review is now recorded evidence under the `land-pr` review obligation, not
...
plus the LCM storage, compaction, lifecycle, lossless import, operator mutation,
access-policy, and memory-preservation modules.
