...
and tag. `v0.24.2` shipped rc-first: the `v0.24.2-rc1` tag carried the identity first, the
gauntlet ran at that tag, and the GA tree is the rc tree plus the GA release-notes
file (as `v0.24.1` did).
